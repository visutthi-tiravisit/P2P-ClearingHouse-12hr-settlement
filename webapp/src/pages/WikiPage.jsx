...
const NAV = [
  {
    ...
    items: [
      ...
      { id: 'background',  label: 'ที่มาและความเป็นมา' },
...
const PAGES = {
  ...
  background: {
    title: 'ที่มาและความเป็นมา',
    badge: 'ภาพรวม',
    sections: [
      {
        heading: 'ปัญหาในตลาดอนุพันธ์สกุลเงินดิจิทัลปัจจุบัน',
        body: 'ตลาดอนุพันธ์ระดับสากลอย่าง Binance หรือ Deribit แม้จะให้บริการออปชัน (Options) แต่สัญญาที่สั้นที่สุดมักเริ่มต้นที่ 1 วัน (Daily Options) ซึ่งนานเกินไปสำหรับการป้องกันความเสี่ยงในระหว่างวัน (Intraday Hedging) นอกจากนี้ ระบบสมุดคำสั่ง (Order Book) ยังกระจายสภาพคล่องตามราคาใช้สิทธิ (Strike Price) ที่หลากหลาย ทำให้ผู้ใช้รายย่อยประสบปัญหาไม่มีคู่สัญญา (Lack of Counterparty) หรือมี Spread สูงจนบริหารความเสี่ยงไม่ได้อย่างมีประสิทธิภาพ',
      },
      {
        heading: 'ความเสี่ยงแบบ All-or-Nothing',
        body: 'โครงสร้างของสัญญาออปชันแบบดั้งเดิม (Vanilla Options) มีลักษณะจ่ายผลตอบแทนคล้ายการพนัน หากราคาตลาดไม่เคลื่อนไปถึงราคาใช้สิทธิภายในเวลาที่กำหนด สัญญาจะถูกนับว่าไร้มูลค่าทันที (Expire Worthless) และผู้ซื้อสูญเสียเงินพรีเมียมทั้งหมด 100% แม้ราคาจะขยับถูกทิศทางแต่ยังไม่ถึงเป้าหมายก็ตาม ลักษณะ "ได้หมดหรือเสียหมด" นี้เป็นอุปสรรคสำคัญที่ทำให้เครื่องมือทางการเงินนี้ไม่ได้รับการนำมาใช้ป้องกันความเสี่ยงอย่างที่ควรจะเป็น',
      },
      {
        heading: 'แนวทางการแก้ปัญหา',
        body: 'งานวิจัยนี้เสนอ P2P Clearing House บนกรอบเวลา 12 ชั่วโมง โดยมีแนวทางหลัก 4 ด้าน:\n\n1. เปลี่ยนระบบ Matching เป็น Pooling — รวบรวมสภาพคล่องจากผู้ใช้ทุกคนไว้ใน pool กลาง ผู้ใช้เปิดสถานะได้ทันทีโดยไม่ต้องรอคู่สัญญาที่มีเงื่อนไขตรงกัน\n\n2. Linear Settlement — เปลี่ยนจากการจ่ายแบบ All-or-Nothing มาเป็นการชำระตามระยะเคลื่อนที่จริงของราคา (Intrinsic Value) รักษาหลักประกันส่วนเกินคืนให้ผู้ใช้ในกรณีราคาขยับเพียงเล็กน้อย\n\n3. Mandatory Settlement อัตโนมัติ — smart contract ทำหน้าที่เป็นสำนักหักบัญชีกลางบังคับใช้สัญญาทุกกรณีเมื่อครบเวลา ทุกการเคลื่อนไหวของราคามีมูลค่าทางการเงิน\n\n4. Risk-Neutral Infrastructure — ตัวกลางไม่แบกรับความเสี่ยงด้านเงินทุน smart contract ทำหน้าที่เพียง escrow และคำนวณส่วนต่างราคาเพื่อจัดสรรเงินระหว่างผู้ชนะและผู้แพ้',
      },
      {
        heading: 'กลไกรักษาเสถียรภาพของกองกลาง',
        body: 'เพื่อป้องกันการถอนสภาพคล่องอย่างฉับพลัน (Bank Run) และการเอาเปรียบด้านข้อมูลช่วงใกล้สิ้นรอบ ระบบใช้กลไกดังนี้:\n\n• Critical Period Lock-up — 90 นาทีสุดท้าย (นาทีที่ 630–720) ไม่อนุญาตให้ถอนหลักประกัน เพื่อให้มีสินทรัพย์เพียงพอชำระบัญชี\n• Late Entry Premium — ผู้เข้ารอบช่วง Critical ยังเปิดสถานะได้แต่ต้องจ่าย Time Premium 5–10% เพื่อชดเชยความได้เปรียบด้านข้อมูลราคา\n• Dynamic Premium Pricing — ปรับค่าธรรมเนียมตามความสมดุลของ pool: ฝั่งที่คนมาก Premium สูง ฝั่งที่คนน้อย Premium ต่ำ เพื่อดึงดูดสภาพคล่อง',
      },
      {
        heading: 'ขอบเขตความปลอดภัย',
        body: '• Next-Tick Settlement — บันทึกราคา oracle ณ เวลา block ถัดไป ป้องกัน Latency Arbitrage\n• Re-entrancy Protection — ทุกฟังก์ชันที่โอน Native ETH มีการป้องกัน re-entrancy\n• Hard Cap — ค่าธรรมเนียมส่วนต่างราคา (R_dist) ถูก cap ไว้ที่ 70% ของ ΔP เพื่อรับประกันว่าผู้เข้าร่วมได้กำไรสุทธิอย่างน้อย 30% ของการเคลื่อนไหวราคา',
      },
      {
        heading: 'สิ่งที่ไม่อยู่ในขอบเขต',
        body: '• Cross-chain Bridge\n• ระบบ Order Book แบบสมบูรณ์ (เน้นเฉพาะ Pooling)\n• กฎหมายท้องถิ่น (ก.ล.ต. ไทย) — ระบบอ้างอิงมาตรฐาน DeFi สากล\n• Fiat-to-Crypto Gateway / KYC\n• การจัดการ Spread, Slippage, หรือ Network Latency ในสูตรชำระบัญชี\n• กลยุทธ์ High-Frequency Trading หรือ Price Manipulation',
      },
    ],
  },
